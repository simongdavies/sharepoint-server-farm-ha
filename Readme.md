...
+ 	Once deployed access can be gained at the following addresses:
	...
	+	SharePoint Website - <dnsPrefix>.<location>.cloudapp.azure.com
	+	Central Admin Website - <spCentralAdminDNSPrefix>.<location>.cloudapp.azure.com
	+	RDP Jump Box - <rdpDNSPrefix>.<location>.cloudapp.azure.com
